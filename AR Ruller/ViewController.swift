...
//  AR Ruller
//
//  Created by Rudolf Amiryan on 23.10.23.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func calculate() {
        ...
        let distance = sqrt((pow(a, 2) + pow(b, 2) + pow(c, 2)) * 1000)
    ...
    func updateText(text: String, atPosition position: SCNVector3) {
        ...
        textNode.position = SCNVector3(x: position.x, y: position.y + 0.1, z: position.z)
